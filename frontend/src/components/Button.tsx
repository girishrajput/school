...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const primaryClasses = 'bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2';
  const secondaryClasses = 'bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2';
